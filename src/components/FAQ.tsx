  ...
  const faqs = [
    {
      ...
      answer:
        "Mobile Fußpflege ist für jeden geeignet, besonders aber für Senioren, Menschen mit eingeschränkter Mobilität, Berufstätige mit wenig Zeit und alle, die eine entspannte Behandlung in gewohnter Umgebung bevorzugen. Diabetiker bitte ich Podologen zu kontaktieren.",
    },
    {
      question: "Was muss ich für den Hausbesuch vorbereiten?",
      answer:
        "Sie müssen nichts Besonderes vorbereiten. Ich bringe alle notwendigen Instrumente, Desinfektionsmittel und Pflegeprodukte mit. Wir benötigen lediglich etwas Platz und ein frisches Frotteehandtuch.",
    },
    {
      question: "Wie läuft ein Hausbesuch ab?",
      answer:
        "Nach der Terminvereinbarung komme ich pünktlich zu Ihnen nach Hause. Wir führen zunächst ein kurzes Beratungsgespräch, dann bereite ich alles vor und beginne mit der Behandlung.",
    },
    {
      question: "Was sind die Hygienestandards?",
      answer:
        "Jede Behandlung erfolgt nach strengen, gesetzlich festgelegten Hygienestandards von RKI, WHO und Gesundheitsbehörden zum Schutz der Gesundheit aller.",
    },
    {
      question: "Welche Kosten entstehen und ist die Anfahrt kostenlos?",
      answer:
        "Die Anfahrt ist in Aachen kostenlos. Die Behandlungskosten richten sich nach der gewünschten Leistung und Aufwand.",
    },
    {
      question: "Wie flexibel sind die Termine?",
      answer:
        "Ich biete sehr flexible Termine an. Folgetermine vereinbaren wir auf Wunsch sofort nach der Behandlung. Terminänderungen sind selbstverständlich möglich.",
    },
    {
      question: "Wie ist meine telefonische Erreichbarkeit?",
      answer:
        "Während einer Behandlung kann ich Ihren Anruf leider nicht entgegennehmen. Bitte hinterlassen Sie mir eine Nachricht, ich melde mich schnellstmöglich zurück.",
    },
    {
      question: "Kann ich einen Gutschein verschenken?",
      answer:
        "Ja, sehr gerne können Sie Gutscheine für meine Leistungen erwerben. Dies ist ein wunderbares Geschenk für Ihre Liebsten. Sprechen Sie mich einfach darauf an.",
    },
  ];
  ...
  const highlightText = (text: string, searchTerm: string) => {
    ...
    return parts.map((part, index) =>
      regex.test(part) ? (
        <span
          key={index}
          className="bg-gradient-to-r from-soft-blue-200 to-soft-blue-300 dark:from-soft-blue-800 dark:to-soft-blue-700 font-semibold px-1 py-0.5 rounded-sm animate-pulse"
        >
          {part}
        </span>
      ) : (
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-clamp-base text-gray-600 dark:text-gray-300 max-w-2xl mx-auto leading-relaxed">
              Hier finden Sie Antworten auf die wichtigsten Fragen zur mobilen
              Fußpflege
            </p>
          </div>
                  ...
                  <p className="text-sm font-medium text-soft-blue-700 dark:text-soft-blue-300">
                    {filteredFaqs.length === 0 ? (
                      ...
                      <span className="flex items-center gap-2">
                        ...
                        {filteredFaqs.length}{" "}
                        {filteredFaqs.length === 1 ? "Ergebnis" : "Ergebnisse"}{" "}
                        gefunden
                      </span>
                    )}
                  </p>
