          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-8 animate-slide-up">
              ...
              <div className="bg-gradient-to-br from-soft-blue-100 to-warm-beige-100 dark:from-gray-800 dark:to-gray-700 rounded-2xl p-8">
                ...
                <h3 className="text-2xl font-bold text-gray-800 dark:text-gray-100 text-center mb-4">
                  Regina Bergen
                </h3>
                <p className="text-center text-soft-blue-600 dark:text-soft-blue-400 font-semibold mb-4">
                  Zertifzierte Fachfußpflegerin
                </p>
              </div>
              ...
              <div className="animate-fade-in">
                <div className="space-y-4 text-gray-700 dark:text-gray-300 leading-relaxed">
                  ...
                  <p className="text-clamp-base">
                    Ich bin Regina Bergen, seit mehr als 11 Jahren mobile
                    Fachfußpflegerin mit zertifizierter Ausbildung und staatlich
                    examinierte Altenpflegehelferin.
                  </p>
                  <p className="text-clamp-base">
                    Besonders am Herzen liegt mir die Betreuung von Senioren,
                    Menschen mit eingeschränkter Mobilität und allen, die sich
                    eine bequeme Behandlung in vertrauter Umgebung wünschen.
                  </p>
                </div>
              </div>
            </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
                        Staatlich examinierte Altenpflegehelferin seit 2010 und
                        Fußpflegeexpertin seit 2014
                      </p>
                    </div>
                  </div>
                </Card>
                ...
                <Card className="p-6 border-l-4 border-l-sage-500 hover:shadow-lg transition-shadow dark:bg-gray-800 dark:border-gray-600">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
                        Besondere Sensibilität für die Bedürfnisse älterer
                        Menschen und hilfebedürftiger Menschen
                      </p>
                    </div>
                  </div>
                </Card>
                ...
                <Card className="p-6 border-l-4 border-l-warm-beige-500 hover:shadow-lg transition-shadow dark:bg-gray-800 dark:border-gray-600">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
                        Professionelle Fußpflege unter Einhaltung strengster
                        Hygienestandards
                      </p>
                    </div>
                  </div>
                ...
                <Card className="p-6 border-l-4 border-l-soft-blue-500 hover:shadow-lg transition-shadow dark:bg-gray-800 dark:border-gray-600">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
                        Die Terminvereinbarung erfolgt flexibel innerhalb Ihrer
