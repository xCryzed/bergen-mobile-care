...
export const Philosophy = () => {
  return (
    <section
      id="philosophy"
      className="py-20 bg-gradient-to-br from-sage-50 to-soft-blue-50 dark:from-gray-800 dark:to-gray-900"
    >
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="relative">
            ...
            <div
              className="absolute -bottom-4 -right-4 w-32 h-32 bg-sage-200 dark:bg-sage-800 rounded-full opacity-20 animate-pulse"
            ...
            <div className="relative bg-white dark:bg-gray-800 rounded-3xl p-8 md:p-12 shadow-2xl border border-soft-blue-100 dark:border-gray-700">
              ...
              <blockquote className="text-clamp-lg md:text-clamp-xl text-gray-700 dark:text-gray-300 leading-relaxed font-medium italic text-center">
                "Gesunde und schmerzfreie Füße tragen entscheidend zu einem
                aktiven und selbstbestimmten Leben bei. Denn wer sich gut
                bewegen kann, bleibt mobiler und fühlt sich wohler."
              </blockquote>
          ...
          <div className="mt-12 text-center">
            <p className="text-clamp-base text-gray-600 dark:text-gray-400 max-w-2xl mx-auto leading-relaxed">
              Diese Überzeugung leitet mich bei jeder Behandlung und motiviert
              mich, Ihnen mit Fachwissen und Einfühlungsvermögen zu helfen
            </p>
          </div>
        </div>
      </div>
