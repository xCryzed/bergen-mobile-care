    ...
    useEffect(() => {
        const updateMetadata = () => {
            ...
            const localBusinessSchema = {
                ...
                "alternateName": ["Mobile Fußpflege Aachen", "Fußpflege Bergen", "Fußpflege Hausbesuch Aachen"],
                "description": "Professionelle mobile Fußpflege in Aachen und Umgebung. Fachfußpflegerin Regina Bergen kommt zu Ihnen nach Hause. ✓ Über 11 Jahre Erfahrung ✓ Zertifiziert ✓ Kostenlose Anfahrt in Aachen",
                ...
                "foundingDate": "2014",
                "slogan": "Gepflegte Füße fördern, erhalten oder steigern die Lebensqualität",
                "hasOfferCatalog": {
                    "@type": "OfferCatalog",
                    ...
                    "itemListElement": [
                        {
                            ...
                            "itemOffered": {
                                ...
                                "description": "Professionelle Fußpflege bei Ihnen zu Hause in Aachen",
                                "category": "Fußpflege",
                                "serviceType": "Mobile Dienstleistung"
                            },
                            "areaServed": ["Aachen", "Herzogenrath", "Würselen", "Alsdorf", "Stolberg"]
                        },
                        {
                            "@type": "Offer",
                            "itemOffered": {
                                ...
                                "description": "Professionelle Nagelkorrektur und -pflege für gesunde Füße",
                        ...
                        },
                        {
                            ...
                            "itemOffered": {
                                ...
                                "description": "Spezielle Fußpflege für Diabetiker mit besonderer Sorgfalt",
            ...
            const personSchema = {
                ...
                "description": "Erfahrene Fachfußpflegerin mit über 11 Jahren Erfahrung und Spezialisierung auf mobile Fußpflege in Aachen. Staatlich examinierte Altenpflegehelferin seit 2010.",
            ...
            const serviceSchema = {
                ...
                "description": "Professionelle mobile Fußpflege direkt bei Ihnen zu Hause in Aachen und Umgebung. Alle Behandlungen werden nach höchsten Hygienestandards durchgeführt. Über 11 Jahre Erfahrung, zertifizierte Fachfußpflegerin, kostenlose Anfahrt in Aachen.",
                "provider": {
                    "@id": "https://fusspflegebergen.de/#business"
                },
                "areaServed": [
            ...
            const websiteSchema = {
                ...
                "description": "Professionelle mobile Fußpflege in Aachen - Regina Bergen kommt zu Ihnen nach Hause. Über 11 Jahre Erfahrung, zertifizierte Fachfußpflegerin.",
                "url": "https://fusspflegebergen.de",
                "potentialAction": {
                    "@type": "SearchAction",
                    "target": {
                ...
                "inLanguage": "de-DE",
                "copyrightYear": "2024",
                "keywords": "mobile fußpflege aachen, fußpflege hausbesuch, podologie aachen, fußpflege zu hause, nagelpflege aachen"
            };
            ...
            const schemas = [localBusinessSchema, personSchema, serviceSchema, faqSchema, websiteSchema, breadcrumbSchema];
            ...
            if (path === '/impressum') {
                document.title = 'Impressum - Mobile Fußpflege Regina Bergen Aachen | Rechtliche Angaben';
                updateMetaTag('description', 'Impressum und rechtliche Angaben zur mobilen Fußpflege Regina Bergen in Aachen. Kontaktdaten, Geschäftsangaben und weitere Informationen zur Fußpflege-Praxis.');
                updateMetaTag('keywords', 'impressum, rechtliche angaben, mobile fußpflege aachen, regina bergen, kontaktdaten');
            } else if (path === '/datenschutz') {
                document.title = 'Datenschutz - Mobile Fußpflege Regina Bergen Aachen | Datenschutzerklärung';
                updateMetaTag('description', 'Datenschutzerklärung der mobilen Fußpflege Regina Bergen. Umfassende Informationen zum Umgang mit Ihren persönlichen Daten bei der Fußpflege-Behandlung.');
                updateMetaTag('keywords', 'datenschutz, datenschutzerklärung, mobile fußpflege aachen, regina bergen, dsgvo');
            } else {
                document.title = 'Mobile Fußpflege Aachen ✓ Regina Bergen ✓ Hausbesuch Fußpflege ✓ Kostenlose Anfahrt';
                updateMetaTag('description', '🦶 Mobile Fußpflege in Aachen ✓ Über 11 Jahre Erfahrung ✓ Zertifizierte Fachfußpflegerin ✓ Kostenlose Anfahrt ✓ Hausbesuch ✓ Jetzt Termin vereinbaren: ☎️ +49 170 1212677');
                updateMetaTag('keywords', 'mobile fußpflege aachen, fußpflege hausbesuch aachen, podologie aachen, fußpflege zu hause, nagelpflege aachen, hornhaut entfernen aachen, fußpflege senioren aachen, diabetiker fußpflege aachen, regina bergen, fachfußpflegerin aachen, mobile fußpflege herzogenrath, fußpflege würselen, fußpflege alsdorf, fußpflege stolberg, mobile podologie, fußpflege termine aachen, professionelle fußpflege, medizinische fußpflege aachen');
            }
            ...
            updateMetaTag('og:title', 'Mobile Fußpflege Aachen ✓ Regina Bergen ✓ Hausbesuch Fußpflege');
            updateMetaTag('og:description', '🦶 Mobile Fußpflege in Aachen ✓ Über 11 Jahre Erfahrung ✓ Zertifizierte Fachfußpflegerin ✓ Kostenlose Anfahrt ✓ Jetzt Termin: ☎️ +49 170 1212677');
            ...
            updateMetaTag('twitter:title', 'Mobile Fußpflege Aachen ✓ Regina Bergen ✓ Hausbesuch');
            updateMetaTag('twitter:description', '🦶 Mobile Fußpflege in Aachen ✓ Über 11 Jahre Erfahrung ✓ Zertifizierte Fachfußpflegerin ✓ Kostenlose Anfahrt');
            ...
            let alternateDe = document.querySelector('link[rel="alternate"][hreflang="de"]');
            if (!alternateDe) {
            ...
            alternateXDefault.setAttribute('href', `https://fusspflegebergen.de${path}`);
