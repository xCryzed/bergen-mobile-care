      ...
      <Card className="max-w-4xl mx-auto bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-lg">
        <div className="p-6">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
            ...
            Website zu bieten. Einige Cookies sind notwendig für den Betrieb der
            Website, während andere uns helfen, die Website zu verbessern und
            Ihnen personalisierte Inhalte anzuzeigen. Sie können Ihre
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm text-gray-600 dark:text-gray-300">
                            Helfen uns zu verstehen, wie Besucher mit der
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm text-gray-600 dark:text-gray-300">
                            Werden verwendet, um Ihnen relevante Werbung zu
                            zeigen.
                          </p>
                        </div>
                        <Switch
