  ...
  return (
    <Card className="p-8 shadow-lg border-l-4 border-l-soft-blue-500 dark:bg-gray-800 dark:border-gray-700">
      ...
      <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
        Ihre Expertin für mobile Fußpflege in Aachen. Ich bringe professionelle
        Fußpflege direkt zu Ihnen nach Hause.
      </p>
      ...
      <div className="space-y-4">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <a
              ...
              className="text-soft-blue-600 dark:text-soft-blue-400 hover:text-soft-blue-700 dark:hover:text-soft-blue-300 font-medium"
            >
              +49 170 1212677
            </a>
          </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <a
              href="mailto:infot@fusspflegebergen.de"
