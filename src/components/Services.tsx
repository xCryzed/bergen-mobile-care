...
export const Services = () => {
  ...
  return (
    <section
      id="services"
      className="py-20 bg-gradient-to-br from-soft-blue-50 to-white dark:from-gray-800 dark:to-gray-900"
    >
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-clamp-base text-gray-600 dark:text-gray-300 max-w-2xl mx-auto leading-relaxed">
              Fachgerechte Fußpflege mit modernsten Methoden bei Ihnen zu Hause
              oder dort, wo Sie sich gerade aktuell in Aachen aufhalten
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg border border-soft-blue-100 dark:border-gray-700">
            <div className="text-center mb-6">
              <h3 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-4">
                Inklusive bei allen Behandlungen
              </h3>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6 text-center">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300">
                  Sterile Instrumente – sichere Behandlung
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300">
                  Praktische Tipps für gesunde und gepflegte Füße
                </p>
              </div>
            </div>
          </div>
