          ...
          <div className="mt-12 bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg">
            <div className="grid md:grid-cols-3 gap-8 text-center">
              <div className="space-y-3">
                <div className="text-3xl font-bold text-soft-blue-600 dark:text-soft-blue-400">
                  Google
                </div>
              ...
              <div className="space-y-3">
                <div className="text-3xl font-bold text-warm-beige-600 dark:text-warm-beige-400">
                  100%
                </div>
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Echt & Transparent
