...
export const Header = () => {
    ...
    return (
        <header
            className="sticky top-0 bg-white/95 dark:bg-gray-900/95 backdrop-blur-sm border-b border-soft-blue-100 dark:border-gray-700 z-50 shadow-sm">
            <div className="container mx-auto px-4 py-4">
                <div className="flex justify-between items-center">
                    ...
                    >
                        {isMenuOpen ? <X className="w-6 h-6 dark:text-gray-300"/> :
