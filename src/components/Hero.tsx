...
export const Hero = () => {
  ...
  return (
    <section className="relative bg-gradient-to-br from-soft-blue-50 via-white to-warm-beige-50 py-16 md:py-24 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-soft-blue-100/20 to-transparent"></div>
      
      <div className="container mx-auto px-4 relative">
        <div className="max-w-4xl mx-auto text-center">
          {/* Badge */}
          <div className="inline-flex items-center px-4 py-2 bg-white/80 backdrop-blur-sm rounded-full border border-soft-blue-200 shadow-sm mb-8 animate-fade-in">
            <Heart className="w-4 h-4 text-soft-blue-600 mr-2" />
            <span className="text-soft-blue-700 font-medium text-sm">Einfühlsam • Professionell • Zuverlässig</span>
          </div>

          {/* Main Headline */}
          <h1 className="text-clamp-3xl md:text-clamp-4xl font-bold text-gray-800 mb-6 leading-tight animate-slide-up">
            <span className="block">Mobile Fußpflege in Aachen</span>
            <span className="text-soft-blue-600">Regina Bergen kommt zu Ihnen nach Hause</span>
          </h1>
          ...
          {/* Location indicator */}
          <div className="flex items-center justify-center mb-10 text-soft-blue-700 animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-slide-up">
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="border-2 border-soft-blue-600 text-soft-blue-600 hover:bg-soft-blue-600 hover:text-white px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300"
            >
              Leistungen ansehen
            </Button>
          </div>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-2xl mx-auto animate-fade-in">
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-soft-blue-600">100%</div>
              <div className="text-sm text-gray-600">Mobile Betreuung</div>
            </div>
          </div>
        </div>
      </div>
